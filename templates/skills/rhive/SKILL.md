...
2. **Signal status line**: Run `touch /tmp/fidgetflo-hive-active` via Bash to light up the 👑 indicator
...
6. **Clear status line**: Run `rm -f /tmp/fidgetflo-hive-active` via Bash to turn off the 👑 indicator
